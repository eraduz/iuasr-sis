...
/**
 * Vult de draaiende database met de Fase E-startdata (een demo-taak en
 * -afspraak) via de idempotente OrganisatieSeeder.
 *
...
return new class extends Migration
{
    ...
    {
        // Bewust geen verwijdering: taken/afspraken en historie blijven bestaan.
    }
};
