...
/**
 * Vult de draaiende database met de Fase C-startdata (contactmoment-types en
 * enkele demo-contactmomenten/notities) via de idempotente OrganisatieSeeder.
 *
...
return new class extends Migration
{
    ...
    {
        // Bewust geen verwijdering: historie blijft bestaan.
    }
};
