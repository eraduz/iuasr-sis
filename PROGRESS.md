...
- **Huidige fase:** Fase 5 afgerond; aanwezigheids- en collegegeldtermijnmodule
  ...
  volledig afgerond (Fasen A–H); module **HR / Personeelszaken** gestart (Fase A
  opgeleverd).
...
- [~] **Module HR / Personeelszaken** (opdrachtgever 2026-07-11:
  ...
  **Ontwerp:** `docs/MODULE-HR-PERSONEELSZAKEN.md` (architectuur, datamodel, rollen,
  ...
  - [ ] **Fase B — Verlof & verzuim (self-service → manager → HR).**
  - [ ] **Fase C — Gesprekken & performance.**
  - [ ] **Fase D — Organisatiestructuur & rapportages.**
  - [ ] **Fase E — Onboarding/offboarding.**
  - [ ] **Fase F — Dashboard, self-service "Mijn HR" & agenda.**
  - [ ] **Fase G — Slimme functies (optioneel).**
