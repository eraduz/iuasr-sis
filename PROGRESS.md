...
- **Huidige fase:** Fase 5 afgerond; aanwezigheids- en collegegeldtermijnmodule
  ...
  volledig afgerond (Fasen A–H); module **HR / Personeelszaken** t/m Fase E
  opgeleverd. Daarna op verzoek opdrachtgever: **HR-medewerker en Manager
  samengevoegd tot één rol** en het **Schoolbestuur één samengevoegd overzicht**
  met de statistieken van alle modules (vijf rubrieken).
