...
| 2026-07-10 | **Collegegeldtarieven 2026-2027 vastgesteld** (opdrachtgever): Pre-Master GV (PMGV) EUR 3.500, Master GV (MGV, "Master IGV") EUR 4.000, PABO EUR 3.500; elk 5 termijnen. Gezet via een migratie (bestaande DB, guarded insert) en `ReferentieSeeder` (verse migrate:fresh). LET OP: voor de Bachelor Islamitische Theologie (ISLTH) is voor 2026-2027 nog GEEN tarief opgegeven -- apart vast te stellen; zonder tarief betalen ISLTH-studenten in dat jaar EUR 0. |
