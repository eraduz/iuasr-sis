...
/**
 * Wijst automatisch de vakken van het betreffende studiejaar (leerjaar) toe aan
 * een inschrijving. Wordt aangeroepen bij eerste inschrijving én bij
 * herinschrijving. Idempotent: dubbele toewijzing wordt voorkomen.
 */
class Vaktoewijzer
{
