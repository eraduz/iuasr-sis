...
<div class="verk-layout">
  ...
  <div class="sis-paper-stage" style="padding:24px;">
    ...
    @elseif ($financieel && $financieel['geblokkeerd'])
      <div class="iuasr-dash-empty" style="border:0;background:#fff;width:100%;">
        ...
        <p>Deze student heeft een achterstallig bedrag van <b>€ {{ number_format($financieel['achterstallig'], 2, ',', '.') }}</b>. Het afgeven van officiële documenten en verklaringen is geblokkeerd tot de schuld is voldaan, of tot de <b>Financiële Administratie</b> een <b>betalingsafspraak</b> vastlegt.</p>
      </div>
    @else
