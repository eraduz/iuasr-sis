...
<div class="iuasr-dash-tbl-card">
  <table class="iuasr-dash-tbl">
    <thead><tr><th>Titel</th><th>Soort</th><th>Auteur(s)</th><th>Talen</th><th>Jaar</th><th>Vakgebied</th><th style="text-align:center;">Exemplaren</th><th class="row-act"></th></tr></thead>
    <tbody>
      @forelse ($publicaties as $p)
        <tr>
          <td class="nm"><a href="{{ route('bibliotheek.publicaties.show', $p) }}">{{ $p->volledigeTitel() }}</a>
      ...
      @empty
        <tr><td colspan="8"><div class="iuasr-dash-empty" style="border:0;"><h3>Geen publicaties</h3><p class="sis-muted">Er zijn geen titels die aan deze filters voldoen.</p></div></td></tr>
      @endforelse
    </tbody>
  </table>
</div>
